<?php
namespace CharitiousChild; // Replace with your desired namespace

class Xs_FAQs_Widget extends \Elementor\Widget_Base {
  ...
  public function get_categories() {
    return [ 'charitious-elements' ]; // Replace with your desired category
  }
  ...
  protected function register_controls() {
    $this->start_controls_section(
      'section_tab',
      [
        'label' => esc_html__( 'FAQs Post', 'charitious' ), // Replace with control section label
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'default' => esc_html__( '6', 'charitious' ),
      ]
    );
