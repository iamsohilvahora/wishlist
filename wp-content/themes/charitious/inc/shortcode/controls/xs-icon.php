...
class Xs_Icon_Controler extends Elementor\Base_Data_Control {
	...
	public static function get_icons() {
		...
		$icons = array(
		    ...
		    'icon icon-symbol xs-check-mark' => 'icon icon-symbol',
		    'icon icon-cogwheel-outline xs-check-mark' => 'icon icon-cogwheel-outline',
		    'icon icon-shopping-cart xs-check-mark' => 'icon icon-shopping-cart',
		    'icon icon-man xs-check-mark' => 'icon icon-man',
		    'icon icon-users2 xs-check-mark' => 'icon icon-users2',
		    'icon icon-support xs-check-mark' => 'icon icon-support',
		);
	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<select class="elementor-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php esc_attr_e( 'Select Icon', 'charitious' ); ?>">
					<option value=""><?php esc_html_e( 'Select Icon', 'charitious' ); ?></option>
