<?php if(is_array($sliders) && !empty($sliders)): ?>
    <section class="xs-welcome-slider">
        ...
        <?php foreach($sliders as $slider): ?>
            ...
            ?>
            <div class="xs-welcome-content banner-verion-5" style="background-image: url(<?php echo esc_url($image);?>);">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 <?php echo esc_attr($text_align);?> text-left">
                            <div class="xs-welcome-wraper">
                                <?php if(!empty($slider['sub_title'])): ?>
                                    <p class="xs-sub-title"><?php echo wp_kses( $slider['sub_title'], array('br' => array()) ); ?></p>
                                <?php endif;?>
