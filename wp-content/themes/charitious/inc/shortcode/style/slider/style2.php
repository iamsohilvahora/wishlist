<?php if(is_array($sliders) && !empty($sliders)): ?>
    <section class="xs-welcome-slider">
        ...
        <?php foreach($sliders as $slider): ?>
            ...
            $welcome_logo = $slider['welcome_logo']['url'];
            ?>
            ...
            <div class="xs-welcome-content" style="background-image: url(<?php echo esc_url($image); ?>);">
                <div class="container">
                    <div class="xs-welcome-wraper color-white">
                       <?php if( !empty($welcome_logo) ) : ?>
                            <?php echo wp_get_attachment_image( $slider['welcome_logo']['id'] , 'full', false, array(
                                'alt'  => esc_attr__('logo', 'charitious')
                            )); ?>
                        <?php endif; ?>
                       <?php if(!empty($slider['title'])): ?>
                        ...
                        <?php if(!empty($slider['description'])): ?>
                            <p class="xs-slider-description">
                                <?php echo wp_kses( $slider['description'], array('br' => array()) ); ?>
                            </p>
                        <?php endif;?>
