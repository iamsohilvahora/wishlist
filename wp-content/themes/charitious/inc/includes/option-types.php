...
function charitious_action_theme_include_custom_option_types() {
    if (is_admin()) {
        $dir = CHARITIOUS_INC . '/includes';
...
add_action('fw_option_types_init', 'charitious_action_theme_include_custom_option_types');
