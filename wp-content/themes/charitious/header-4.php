...
<header class="xs-header box-header xs-header-4">
    ...
    <div class="container">
		...
		<?php $show_topbar		 = charitious_option( 'show_topbar', charitious_defaults( 'show_topbar' ) ); ?>
			...
			<div class="xs-top-bar top-bar-boxed">
				<div class="row">
					...
					<div class="col-md-6">
						...
						if ( $show_donate_btn ):
                            $donate_link = charitious_option('donate_button_link');
						if($donate_link != ''){
						    ?>
                            <a href="<?php echo esc_html( home_url('/') . $donate_link ); ?>" class="btn btn-info"><i class="fa fa-heart"></i> <?php echo esc_html($donate_text); ?></a>
                            <?php
                        } endif; ?>
					</div>
				</div>
